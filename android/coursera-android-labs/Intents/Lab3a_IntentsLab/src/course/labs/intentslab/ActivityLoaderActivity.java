...
public class ActivityLoaderActivity extends Activity {
	...
	static private final int GET_TEXT_REQUEST_CODE = 100;
	static private final String URL = "http://www.kenh14.vn";
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == GET_TEXT_REQUEST_CODE)
		{
			if (resultCode == Activity.RESULT_OK) {
				String message = data.getStringExtra(ExplicitlyLoadedActivity.EXTRA_MESSAGE);

				TextView mUserView = (TextView) findViewById(R.id.textView1);
				mUserView.setText(message);
			}
		}
    }
}
