...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> data = bundle.getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);


		Integer[] Ids = new Integer[data.size()];
		for(int i = 0; i < data.size(); i++)
			Ids[i] = Integer.valueOf(data.get(i));
		
		// TODO: Start the DownloaderTask

		mDownloaderTask.execute(Ids);
	...
	public class DownloaderTask extends AsyncTask<Integer, Integer, String[]> {
		...
		@Override
		protected String[] doInBackground(Integer... redId) {
			String[] ret;
			ret = downloadTweets(redId);
			return ret;
		}
					...
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							if (getResultCode() != MainActivity.IS_ALIVE) {
								...
								PendingIntent mPendingIntent = PendingIntent.getActivity(mContext, 0, restartMainActivityIntent,PendingIntent.FLAG_UPDATE_CURRENT);
								...
								if(success)
									mContentView.setTextViewText(R.id.text,mContext.getString(R.string.download_succes_string));
								else
									mContentView.setTextViewText(R.id.text,mContext.getString(R.string.download_failed_string));
